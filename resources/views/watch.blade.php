                            ...
                            <div class="video-player-wrapper">
                                @if($video->video_path)
                                    <div class="custom-video-player" id="videoPlayer">
                                        <video id="mainVideo" src="{{ route('video.stream', $video->id) }}" autoplay></video>
                                            ...
                                            <div class="progress-area" id="progressArea">
                                                ...
                                                <div class="player-preview-tooltip" id="previewTooltip">
                                                    <div class="preview-video-container">
                                                        <video id="previewVideo" src="{{ route('video.stream', $video->id) }}" muted preload="auto"></video>
                                                    </div>
                                            ...
                                            <div class="controls-bar">
                                                <div class="left-controls">
                                                    ...
                                                    <div class="volume-container">
                                                        <button class="control-btn" id="muteBtn" title="Muted (m)">
                                                            <svg class="volume-up-icon" viewBox="0 0 24 24" fill="currentColor">
                                                ...
                                                <div class="right-controls">
                                                    ...
                                                    <div class="speed-container">
                                                        <button class="speed-btn" id="speedBtn" title="Kecepatan Putar">1.0x</button>
                                                    ...
                                                    <!-- Fullscreen Button -->
                                                    <button class="control-btn" id="fullscreenBtn" title="Layar Penuh (f)">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            function showOverlayIcon(type) {
                ...
                if (type === 'play') {
                    iconContainer.innerHTML = `<svg viewBox="0 0 24 24" class="w-8 h-8"><path d="M8 5v14l11-7z"/></svg>`;
                } else {
                    iconContainer.innerHTML = `<svg viewBox="0 0 24 24" class="w-8 h-8"><path d="M6 19h4V5H6v14zm8-14v14h4V5h-4z"/></svg>`;
                }
