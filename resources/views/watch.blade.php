                ...
                <div class="lg:col-span-1">
                    <div class="flex flex-col gap-6 h-full">
                        ...
                        <div class="timer-badge">
                            <span class="text-xs uppercase tracking-wider text-red-300 font-semibold block mb-2">Sisa Waktu Menonton Anda</span>
                            <div id="countdown" class="countdown-time mb-2">Menghitung...</div>
                            <span class="text-xs text-red-300 block">
                                Batas Akses: {{ $access->valid_until->format('d M Y H:i') }}
                            </span>
                        </div>

                        <!-- Video Metadata Card -->
                        <div class="watch-info-card flex-grow">
